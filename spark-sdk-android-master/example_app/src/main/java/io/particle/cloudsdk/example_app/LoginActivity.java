        ...
        findViewById(R.id.login_button).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        final String email = "mchoun95@mit.edu";//((EditText) findViewById(R.id.email)).getText().toString();
                        final String password = "mark1995"; //((EditText) findViewById(R.id.password)).getText().toString();
...
//                        task.execute();
                        ...
                        Async.executeAsync(ParticleCloud.get(v.getContext()), new Async.ApiWork<ParticleCloud, Object>() {
                            ...
                            public Object callApi(ParticleCloud sparkCloud) throws ParticleCloudException, IOException {
                                ...
                                mDevice = sparkCloud.getDevice("210034000c47343233323032");
                                Object obj;

                                try {
                                    obj = mDevice.getVariable("weight");
                                    Log.d("Weight", "analogvalue: " + obj);
